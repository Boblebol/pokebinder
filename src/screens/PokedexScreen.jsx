          ...
          {['national', 'regional'].map(m => (
            <button
              ...
              style={{
                ...
                borderRadius: 7,
                border: 'none',
                background: dexMode === m ? theme.accent : 'transparent',
                color: dexMode === m ? '#fff' : 'rgba(255,255,255,.38)',
                cursor: 'pointer',
                fontSize: 12,
                fontWeight: 600,
                fontFamily: 'inherit',
