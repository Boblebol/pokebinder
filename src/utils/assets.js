...
const TRAINER_NAME_MAP = {
  ...
  'levy': 'tate',
  'tatia': 'liza',
  'levy & tatia': 'tateandliza-gen3',
  'tate & liza': 'tateandliza-gen3',
  'marc': 'wallace',
  'juan': 'juan',
  'pierrick': 'roark',
  'gardenia': 'gardenia',
  ...
  // French-specific Leader name corrections
  'tcheren': 'cheren',
  'watson': 'drayden',
  'inezia': 'elesa',
  'amana': 'marlon',
  ...
  'nemona': 'nemona-s',
  'menzi': 'nemona-s',
  'rival menzi': 'nemona-s',
  'arven': 'arven-s',
  'pepper': 'arven-s',
  'rival pepper': 'arven-s',
  'penny': 'penny',
  'pania': 'penny',
  'rival pania': 'penny',
  'aaron': 'aaron',
